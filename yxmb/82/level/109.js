    ...
    LoadAccess: function(a) {
        ...
        NewEle("DivTeach", "div", 0, 0, EDAll); (function(d) {
            ...
            case 1:
                ...
                []);
                c.innerHTML = '<span style="font-size:22px">不过这里既冰，又有油！(点击继续)</span>';
                break;
            case 2:
                PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
                c.onclick = null;
            ...
            case 4:
                ...
                []);
                c.innerHTML = '<span style="font-size:22px">还有一个小秘密，木头和铁都经不起火烧的！(点击继续)</span>';
                break;
            case 5:
...
{
    AZ: [[oZomboni, 1, 10, [10, 20, 30]], [oCZomboni, 1, 10, [10, 20, 30]], [oZomboni, 1, 10, [10, 20, 30]], [oCZomboni, 2, 1]], 
    FlagNum: 30,
    FlagToSumNum: {
