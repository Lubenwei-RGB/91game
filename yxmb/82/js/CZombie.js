...
oFlagZombie = InheritO(oZombie, {
    PicArr: (function() {
        ...
        return ["images/Card/Zombies/FlagZombie.png", a + "0.gif", a + "FlagZombie.gif", a + "FlagZombieAttack.gif", a + "FlagZombieLostHead.gif", a + "FlagZombieLostHeadAttack.gif", "images/Zombies/Zombie/ZombieHead.gif" + $Random, "images/Zombies/Zombie/ZombieDie.gif" + $Random, "images/Zombies/BoomDie.gif" ]
    })(),
    EName: "oFlagZombie",
    CName: "旗帜僵尸",
    OSpeed: 2.2,
...
oBucketheadZombie = InheritO(oConeheadZombie, {
    ...
    SunNum: 125,
    PlayNormalballAudio: function() {
        PlayAudio(["", ""][Math.floor(Math.random() * 2)])
    },
...
oFootballZombie = InheritO(oConeheadZombie, {
    ...
    PicArr: (function() {
        ...
        return ["images/Card/Zombies/FootballZombie.png", a + "0.gif", a + "FootballZombie.gif", a + "Attack.gif", a + "LostHead.gif", a + "LostHeadAttack.gif", "images/Zombies/Zombie/ZombieHead.gif" + $Random, a + "Die.gif" + $Random, "images/Zombies/BoomDie.gif" + $Random, a + "", a + "1.gif"]
    })(),
    getShadow: function(a) {
...
oScreenDoorZombie = InheritO(oNewspaperZombie, {
    ...
    getFirePea: function(c, a, b) {
        PlayAudio(b == c.WalkDirection ? ["", ""][Math.floor(Math.random() * 2)] : "splat" + Math.floor(1 + Math.random() * 3));
        c.getHit0(c, a, b)
    },
    getFirePeaSputtering: function() {},
    getSnowPea: function(c, a, b) {
...
oDuckyTubeZombie2 = InheritO(oDuckyTubeZombie1, {
    ...
    PicArr: (function() {
        ...
        return ["images/Card/Zombies/DuckyTubeZombie1.png",  b + "Walk1.gif", b + "Walk2.gif", b + "Attack.gif", "images/Zombies/Zombie/ZombieHead.gif" + $Random, a + "Die.gif" + $Random, a + "Walk1.gif", a + "Walk2.gif", a + "Attack.gif"]
    })(),
    AudioArr: ["", "zombie_entering_water"],
...
oCZomboni = function() {
    ...
    return InheritO(oZomboni, {
        ...
        PicArr: (function() {
            ...
            return ["images/Card/Zombies/Zomboni.png", b + "1.gif", b + "2.gif", b + "3.gif", b + "4.gif", b + "5.gif" + $Random, b + "BoomDie.gif" + $Random, b + "ice.png", b + "ice_cap.png"]
        })(),
...
oJackinTheBoxZombie = InheritO(OrnNoneZombies, {
    ...
    DisappearDie: function() {
        this.Status && !--oGd.$JackinTheBox && StopAudio("");
        ClearChild(this.Ele);
        this.HP = 0;
        delete $Z[this.id];
        this.PZ && oP.MonPrgs()
...
oBalloonZombiePlus = InheritO(OrnIZombies, {
    EName: "oBalloonZombiePlus",
    CName: "加强版气球僵尸",
    HP: 750,
    OrnHP: 50,
    StandGif: 2,
    ...
    Produce: '气球僵尸漂浮在空中，躲过大多数攻击。<p>韧性：<font color="#FF0000">高</font><br>特点：<font color="#FF0000">飞行</font><br>弱点：<font color="#FF0000">仙人掌和三叶草</font></p>气球僵尸真幸运。气球有很多功效，而其他僵尸都不曾捡到过。',
    GetDX: function() {
        return - 10
    },
    BirthCallBack: function(e) {
...
oNewspaperZombiePlus = InheritO(OrnIIZombies, {
    EName: "oNewspaperZombiePlus",
    CName: "加强版读报僵尸",
    OrnHP: 500,
    Lvl: 2,
    LostPaperGif: 13,
    ...
    AudioArr: ["newspaper_rarrgh2"],
    Produce: '他的报纸只能提供有限的防御。<p>韧性：<font color="#FF0000">中</font><br>报纸韧性：<font color="#FF0000">低</font><br>速度：正常，而后快(失去报纸后)</p>读报僵尸，他正痴迷于完成他的数独难题。难怪他这么反常。',
    getShadow: function(a) {
        return "left:75px;top:" + (a.height - 25) + "px"
    },
    GoingDie: function(b) {
...
oPoleVaultingZombiePlus = InheritO(OrnNoneZombies, {
    EName: "oPoleVaultingZombiePlus",
    CName: "撑杆僵尸加强版",
    HP: 720,
    width: 348,
    height: 218,
    ...
    AudioArr: ["polevault", ""],
    Produce: '撑杆僵尸运用标杆高高地跃过障碍物。<p>韧性：<font color="#FF0000">高</font><Br>速度：<font color="#FF0000">快,而后慢(跳跃后)</font><BR>特点：<font color="#FF0000">跃过他所碰到的第一筑植物</font></p>一些僵尸渴望走得更远、得到更多，这也促使他们由普通成为非凡。那就是撑杆僵尸。',
    getShadow: function(a) {
        return "left:" + (a.beAttackedPointL - 20) + "px;top:" + (a.height - 35) + "px"
    },
    GoingDieHead: function(c, a, b) {
