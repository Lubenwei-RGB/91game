...
oS = {
    ...
    CheckImg: function(b, a) {
        ...
        $("sFlagMeterTitleF").innerHTML = '<span style="cursor:pointer;font-family:Yahei Mono;color:#fff">正在加载(' + c.AccessNum + "/" + c.PicNum + ")</span>";
...
oP = {
    ...
    SelectFlagZombie: function(j, d) {
        ...
        c = false,
        h = !n ? 150 : (PlayAudio(""), n.style.top = "5px", --j, i[g++] = oS.FlagZombie || oFlagZombie, 30),
        p,
        b,
        f = e.MustShowAtFlag,
        a;
...
GroundOnmousedown = function(i) {
    ...
    switch (oS.Chose) {
    case 1:
        WhichMouseButton(i) < 2 ? GrowPlant(j[0], d, c, f, b) : (PlayAudio(""), CancelPlant());
        break;
    case - 1 : WhichMouseButton(i) < 2 ? (PlayAudio(""), ShovelPlant(j)) : (PlayAudio(""), CancelShovel())
    }
},
...
InitHandBookZCard = function() {
    PlayAudio("");
    var d = "",
   g, f, e = [oZombie, oConeheadZombie, oPoleVaultingZombie, oBucketheadZombie, oFlagZombie, oNewspaperZombie, oScreenDoorZombie, oFootballZombie, oHeiFootballZombie, oDancingZombie,oBackupDancer,oDuckyTubeZombie1, oSnorkelZombie, oZomboni, oDolphinRiderZombie, oBalloonZombie, oJackinTheBoxZombie, oImp,oCZombie, oCConeheadZombie,oCBucketheadZombie,oEunZombie, othugZombie, oZZ, oEmperor, oCXZombie, oXBZombie, oJX, oJY, oLGBOSS, oWarshipsZombie, oSubZombie, oWJY,oMustacheZombie,oTrashZombie,oLionDanceZombie,oZombie2,oZombie3,oCFootballZombie,oCPoleVaultingZombie,oCNewspaperZombie,oDuckyTubeZombie2,oDuckyTubeZombie3,oDuckyTubeZombie4,oSmallZombie,oSmallFlagZombie,oSmallDuckyTubeZombie1,oSmallConeheadZombie,oSmallFootballZombie,oSmallSnorkelZombie,oCZomboni,oCJackinTheBoxZombie,oCZombie2,oCZombie3,oWJY1,oBalloonZombiePlus,oNewspaperZombiePlus,oPoleVaultingZombiePlus],
    a = e.length,
    b = 0,
    c;
    while (b < a) {
...
ShowLoginDiv = function() {
    $User.isAuthorWebsite ? (PlayAudio("")) : GotoAuthorWebsite("")
},
CheckLogin = function() {
    var c = $("txtName").value,
    e = $("txtPass").value,
...
ClickMenu = function() {
    oSym.Timer && (AllAudioPaused(), PlayAudio(""), oSym.Stop(), SetBlock($("dSurface")), innerText($("dMenu0"), "调 速"), ShowOptions())
},
...
HiddenMiniGame = function(a) { ! a && PlayAudio("");
...
HiddenRiddleGame = function(a) { ! a && PlayAudio("");
...
ViewHandBook = function() {
    SetNone($("dOptionsMenuback"), $("dOptionsMenu"));
    oS.Lvl ? (AllAudioPaused(), PlayAudio(""), SetNone($("dSurface")), oSym.Stop(), innerText($("dMenu0"), "回到游戏"), $("dMenu1").onclick = null) : (AllAudioPaused(), PlayAudio(""));
