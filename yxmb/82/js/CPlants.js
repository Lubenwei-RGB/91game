...
//o*****（该植物代码） = InheritO(oFumeShroom, 
//证明该植物是夜晚植物，在白天场景需要咖啡豆。
var CPlants = NewO({
    name: "Plants",
    HP: 300,
    PKind: 1,
...
oGraveBuster = InheritO(CPlants, {
    ...
    Tooltip: "咬咬碑会吃掉墓碑。",
    Produce: '咬咬碑用来吃掉墓碑。<p>使用方法：<font color="#FF0000">单次使用，只对墓碑生效。</font><br>特点：<font color="#FF0000">吞噬墓碑。</font></p>尽管咬咬碑的外表十分吓人，但他想要所有人</font><br>都知道，其实他喜欢小猫咪，而且利用业余时</font><br>间，在一家僵尸康复中心做志愿者。“我只是</font><br>在做正确的事情，”他说。</font><br>耐久：70',
    PrivateBirth: function(a) {
...
oSnowPea = InheritO(oPeashooter, {
    ...
    AudioArr: ["frozen", "shieldhit", "shieldhit2"],
...
oLight = InheritO(CPlants, {
        ...
        beAttackedPointR: 51,
        PicArr: function() {
            var B = "images/Props/Light/";
            return ["images/Card/Light.png", B + "p.gif", B + "Light.gif"]
        }(),
        ...
        PrivateBirth: function(B) {
            oSym.addTask(40, function(D) {
                var G, H, E = $P[D];
                E && (G = E.R, H = E.C, E.Die(), oS.StaticCard && AppearSun(GetX(H) - 41 * Math.random(), GetY(G), 300, 0))
            }, [B.id])
        }
    }),
oSquash = InheritO(CPlants, {
    ...
    TriggerCheck: function(h, g, e) {
        ...
        a = $(b).childNodes[1],
        f = h.isAttacking;
        h.beAttacked && h.Altitude > -1 && h.Altitude < 2 && (f || !f && c - this.AttackedRX < 71) && (PlayAudio(""), oT.$[this.R].splice(e, 1), a.src = c > this.AttackedRX ? "images/Plants/Squash/SquashR.png": "images/Plants/Squash/SquashL.png", oSym.addTask(100,
        function(d, j, i) {
            var k = $P[d];
...
oLaserBean = InheritO(CPlants, {
    ...
    oLSP1 = InheritO(CPlants, {
        ...
        PicArr: function() {
            return ["", "", "images/Props/LSP/" + "LSP1.gif"]
        }(),
        PrivateBirth: function(B) {
            oSym.addTask(1500, function(D) {
                var F, G, E = $P[D];
                E && (F = E.R, G = E.C, E._Die())
            }, [B.id])
        },
        InitTrigger: function() {},
        BoomDie: function() {},
        Die: function() {},
        _Die: CPlants.prototype.Die
    }),
 oLSP = InheritO(CPlants, {
        ...
        coolTime: 0,
        PicArr: function() {
            var B = "images/Props/LSP/";
            return ["images/Card/LSP.png", B + "LSP.gif", B + "LSP1.gif"]
        }(),
        Tooltip: "\u6DB2\u6001\u4FDD\u62A4\u819C\u53EF\u4EE5\u4E3A\u4F60\u63D0\u4F9B3x3\u7684\u4FDD\u62A4!",
        Story: "\u90A3\u4E48\u95EE\u9898\u6765\u4E86\uFF0C\u5305\u88C5\u819C\u7B97\u662F\u690D\u7269\u5417\uFF1F--\u7B54\u6848\u662F\u80AF\u5B9A\u7684\uFF1A\u4E0D\u662F\u3002\u8FD9\u79CD\u5305\u88C5\u819C\u6548\u679C\u4F4E\u5EC9\uFF0C\u8FC7\u4E00\u6BB5\u65F6\u95F4\u5C31\u4F1A\u8131\u843D\u3002",
        BirthStyle: function(B, D, E, F) {
            E.childNodes[1].src = this.PicArr[1], EditEle(E, {
                id: D
            }, F, EDPZ)
        },
        Panding: function(B, D) {
            var E = D[B + 0],
                F = D[B + 1],
                G = D[B + 2],
                H = "oObstacle",
                ...
                K = "oObstacle4",
                L = 1;
            return E && (E.EName == H || E.EName == I || E.EName == J || E.EName == K) && (L -= 1), F && 1 == L && (F.EName == H || F.EName == I || F.EName == J || F.EName == K) && (L -= 1), (G && 1 == L && (G.EName == H || G.EName == I || G.EName == J || G.EName == K) && (L -= 1), L)
        },
        PrivateBirth: function(B) {
            var F, G, K, M, D = B.R,
                E = B.C,
            ...
            for (F = D - 1; F <= D + 1; F++)
                if (0 < F && F <= H)
                    for (K = J[D], G = E - 1; G <= E + 1; G++) 0 < G && G <= I && (1 == K || 3 == K) && (M = F + "_" + G + "_", B.Panding(M, L) && CustomSpecial(oLSP1, F, G), oSym.addTask(20, function(N) {
                        var P, Q, O = $P[N];
                        O && (P = O.R, Q = O.C, O.Die(), ClearChild($(B.id + "_2")))
                    }, [B.id]))
        },
        PrivateDie: function(B) {
            B.BulletEle = null
        }
    }), 
